...
def initialize():
    os.chdir(bcdpath)
    os.system('mkdir cdf')
    os.system('cp /Users/rfinn/research/KISS/data/cdf/flatfield_24_kiss.nl cdf/flatfield_24_kiss.nl')
#os.system('cp /Users/rfinn/clusters/spitzer/flatfield_24_ediscs.2.nl cdf/.')
    os.system('cp /Users/rfinn/research/KISS/data/cdf/mosaic_24_kiss.nl cdf/mosaic_24_kiss.nl')
    os.system('ln -s /Applications/mopex/cal cal')
    os.system('mkdir firstframes')
    os.system('mv SPITZER*_0000_1_*.fits firstframes/')
    os.system('ls SPITZER*ebcd.fits  > InputImageList.txt')
    os.system('ls SPITZER*ebunc.fits > SigmaList.txt')
...
def extractphotnoring():#implement airy ring subtraction
    combinepath=bcdpath+'pbcd/Combine/'
    os.chdir(combinepath)
    os.system('mkdir cal')
    os.system('mkdir cdf')
    os.system('cp /Users/rfinn/mopex/cal/mips24_prf_mosaic_2.45_4x.fits cal/.')
    os.system('cp /Users/rfinn/clusters/spitzer/*.nl cdf/.')

    os.system('apex_1frame.pl -n apex_1frame_noring.nl')
    os.system('apex_qa.pl -n apex_qa_noring.nl')

    os.system('apex_1frame.pl -n apex_1frame_step2a.nl')#run detect on ringless image to create a list of sources
    step2path=combinepath+'apex_1frame_step2/'

    os.chdir(step2path)
    os.system('mv residual_mosaic_detect.tbl mosaic_detect.tbl')#cp files to correct names for flux estimation
    os.system('mv residual_mosaic_detect_raw.tbl mosaic_detect_raw.tbl')#cp files to correct names for flux estimation
    os.system('mv residual_mosaic_minus_median_detect.fits mosaic_minus_median_detect.fits')
    os.system('mv residual_mosaic_minus_median_extract.fits mosaic_minus_median_extract.fits')
    os.system('mv residual_mosaic_noise.fits mosaic_noise.fits')
    os.system('mv residual_mosaic_PSP.fits mosaic_PSP.fits')

    os.chdir(combinepath)
    os.system('apex_1frame.pl -n apex_1frame_step2b_raf.nl')#run flux estimation using the original image
    os.system('apex_qa.pl -n apex_qa.nl')#produce point source subtracted image to gauge how well detection went
    image='apex_qa/Mosaic/residual_mosaic.fits'
    iraf.images.tv.display(image,3,contrast=0.01)#CL1040
def writephotcat():
    ...
    if SqDegS < 0.1:
	    ...
	    os.system(string)
	    string='cp mosaic_minus_median_extract.fits /Users/rfinn/clusters/spitzer/final-images/'+prefix+'_final24.fits'
	    os.system(string)
...
if SqDegS < 0.1:#run for KISS galaxies
	prefix=sys.argv[1]
	bcdpath='/Users/rfinn/research/KISS/data/'+prefix+'/mips24/ch1/bcd/'
...
getphot24()#pulls out the line in each mosaic_extract.tbl corresponding to kiss galaxy

getphotirac()#pulls out the line in each extract.tbl corresponding to kiss galaxy
