#!/usr/bin/env python
"""
re-written for Wifi ediscs scans

useage:

wifiediscsreduce24.py cl1054-1245
...
prefix=sys.argv[1]
rootpath='/Users/rfinn/research/WifiEdiscs/MipsScans/Rudnick/'+prefix
catalogpath='/Users/rfinn/research/WifiEdiscs/MipsScans/catalogs/' #catalogpath is the directory where the final catalog will be copied to
print 'got here 1'
os.chdir(rootpath)
...
for rdir in dirs:#run flatfield on each aor
	bcdpath='/Users/rfinn/research/WifiEdiscs/MipsScans/Rudnick/'+prefix+'/'+rdir+'/ch1/bcd/'
...
print 'got here 7'
s="sed -e 's@cl1054-1245@"+prefix+"@g'< /Applications/mopex/cdf/cl1054-1245scan24.nl > /Applications/mopex/cdf/"+prefix+"scan24.nl"
print s
os.system(s)
