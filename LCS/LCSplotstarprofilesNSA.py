...
class cluster(baseClusterNSA):
    ...
    def __init__(self,clustername):
        ...
        self.analyze_mips=self.On24ImageFlag & (self.snr24 > snr24cut) & (self.n.SERSIC_TH50 > mipspixelscale)
        self.analyze_mips=self.On24ImageFlag & (self.snr24 > snr24cut) & (self.n.SERSIC_TH50 > mipspixelscale) & self.spiralflag
