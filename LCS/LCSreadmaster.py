...
#Get current path so program can tell if this is being run on Becky or Rose's computer
    ...
    def getFilesForProfileFitting(self):
        outfile1='/home/rfinn/research/LocalClusters/ProfileFitting/'+self.prefix+'Spirals.Images.24.dat'
        outfile2='/home/rfinn/research/LocalClusters/ProfileFitting/'+self.prefix+'Spirals.Images.sdss.dat'
        outfile3='/home/rfinn/research/LocalClusters/ProfileFitting/'+self.prefix+'Spirals.24.dat'
        outfile4='/home/rfinn/research/LocalClusters/ProfileFitting/'+self.prefix+'Spirals.sdss.dat'
        agcSpiral=self.agcnumber[self.spiralFlag]
        out1=open(outfile1,'w')
        out2=open(outfile2,'w')
        out3=open(outfile3,'w')
        out4=open(outfile4,'w')
        cutoutpath='/home/rfinn/research/LocalClusters/cutouts/'+self.prefix+'/'
	    ...
	    outim24=cutoutpath+self.prefix+'-'+str(agcSpiral[i])+'-cutout-24-rot.fits \n'
            out1.write(outim24)
            out2.write(outim)
            outfile='/home/rfinn/research/LocalClusters/EllipseTables/'+self.prefix+'/'+self.prefix+'-'+str(agcSpiral[i])+'-cutout-sdss.dat \n'
            outfile24='/home/rfinn/research/LocalClusters/EllipseTables/'+self.prefix+'/'+self.prefix+'-'+str(agcSpiral[i])+'-cutout-24-rot.dat \n'
    ...
    def checkmorph(self):#print out files that our class and burstein type disagree or no burstein type
        ...
        s='/home/rfinn/research/LocalClusters/MorphologyF2011/'+self.prefix+'.funnySpirals.dat'
        outfile=open(s,'w')
        s='/home/rfinn/research/LocalClusters/MorphologyF2011/'+self.prefix+'.funnySpirals'
        outfile2=open(s,'w')
        for i in range(len(self.funnySpirals)):
            if  self.prefix in 'Coma Hercules A1367':
                name='/home/rfinn/research/LocalClusters/cutouts/'+self.prefix+'/'+self.prefix+'-'+str(self.funnySpirals[i])+'-cutout-sdss.fits \n'
            else:
                name='/home/rfinn/research/LocalClusters/cutouts/'+self.prefix+'/'+self.prefix+'-'+str(self.funnySpirals[i])+'-cutout-sdss-g.fits \n'
            outfile.write(name)
        ...
        s='/home/rfinn/research/LocalClusters/MorphologyF2011/'+self.prefix+'.noBsteinSpirals.dat'
        outfile=open(s,'w')
        s='/home/rfinn/research/LocalClusters/MorphologyF2011/'+self.prefix+'.noBsteinSpirals'
        outfile2=open(s,'w')
        for i in range(len(self.funnySpirals)):
            if  self.prefix in 'Coma Hercules A1367':
        ...
        s='/home/rfinn/research/LocalClusters/MorphologyF2011/'+self.prefix+'.noMorph.dat'
        outfile=open(s,'w')
        s='/home/rfinn/research/LocalClusters/MorphologyF2011/'+self.prefix+'.noMorph'
        outfile2=open(s,'w')
        for i in range(len(self.funnySpirals)):
            if  self.prefix in 'Coma Hercules A1367':
    ...
    def fitprofiles(self):
        ...
        for i in range(int(npage)):
            ...
            subplots_adjust(left=0.1, right=.95,bottom=.15,top=0.9,wspace=0.2,hspace=0.2)
            clf()
            for j in range(0,ncol*nrow,8):
                ...
                fits.close()
                axis('equal')
                imshow(-1.*(im),interpolation='nearest',origin='upper',vmin=vminsdss,vmax=vmaxsdss)                           
                ax=gca()
                ax.set_yticklabels(([]))
                ax.set_xticklabels(([]))
                text(.9, .5, galname, horizontalalignment='center', verticalalignment='center',rotation=90, transform=ax.transAxes)
                s='$\Delta v/\sigma = %5.3f$'%(redshift[ngal])
...
##                text(.9, .5, galname, horizontalalignment='center', verticalalignment='center',rotation=90, transform=ax.transAxes)
                ...
                r90,sky,r90EncFlux,MaxEncFlux=calcC90(x,y,yerr,tflux)
                ...
                fits.close()
                axis('equal')
                imshow(-1.*(im),interpolation='nearest',origin='upper',vmin=vmin24,vmax=vmax24)                           
                ax=gca()
                ax.set_yticklabels(([]))
                ax.set_xticklabels(([]))
                text(.9, .5, galname, horizontalalignment='center', verticalalignment='center',rotation=90, transform=ax.transAxes)
                s='$\Delta r/R_{200} = %5.3f$'%(dr[ngal])
                text(.1, .5, s, horizontalalignment='center', verticalalignment='center',rotation=90, transform=ax.transAxes)
...
def plotpositionsall():
    ...
    savefig('/home/rfinn/research/LocalClusters/SamplePlots/PlotPositionsAll.eps')
...
def plotpositionson24all():
    ...
    savefig('/home/rfinn/research/LocalClusters/SamplePlots/PlotPositionsOn24All.eps')
...
def plotrelativepositionson24all():
    ...
    savefig('/home/rfinn/research/LocalClusters/SamplePlots/PlotRelativePositionsOn24All.eps')
...
def plotveldrall():
    ...
    savefig('/home/rfinn/research/LocalClusters/SamplePlots/PlotVeldrAll.eps')
...
def plotveldron24all():
    ...
    savefig('/home/rfinn/research/LocalClusters/SamplePlots/PlotVeldrAllOn24.eps')
